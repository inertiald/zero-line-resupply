...
import robotiq_gripper_codex as robotiq_gripper
import time
import math
...
def main():
    ...
    try:
        ...
        # Connect to Robotiq Gripper via RTDE
    ...
    while True:
        ...
        print("5. Unlock Protective Stop & Restart Safety (Dashboard API)")
        print("6. Compute Approach Pose (Camera to Robot Transform)")
        print("7. Visual Servoing (Smooth Dynamic Tracking)")
        print("8. Safe Grasp (moveUntilContact + Gripper)")
        print("9. Exit")
        ...
        if choice == '1':
            ...
            # Clear faults and protective stops via Dashboard Client
